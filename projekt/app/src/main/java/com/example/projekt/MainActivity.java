...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.oktawa6:
                ...
                break;
            case R.id.oktawa7:
                Intent oktawa7_activity = new Intent(context, Oktawa7.class);
                oktawa7_activity.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP |
                        Intent.FLAG_ACTIVITY_SINGLE_TOP);
                finish();
                startActivity(oktawa7_activity);
                break;
            case R.id.start_rec:
            ...
            case R.id.stop_rec:
                ...
                //String fname = getFilesDir() + "test_record.txt";
                String fname =getExternalStorageDirectory() + "test_record.txt";
                try {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sound_a = sP.load(this, R.raw.a1, 1);
        sound_b = sP.load(this, R.raw.b1, 1);
        sound_c = sP.load(this, R.raw.c1, 1);
        sound_d = sP.load(this, R.raw.d1, 1);
        sound_e = sP.load(this, R.raw.e1, 1);
        sound_f = sP.load(this, R.raw.f1, 1);
        sound_g = sP.load(this, R.raw.g1, 1);
        sound_c2 = sP.load(this, R.raw.c2, 1);
