...
public class Oktawa3 extends AppCompatActivity {
    Button button_a;
    Button button_b;
    Button button_c;
    Button button_d;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oktawa3);
        ...
        sound_a = sP.load(this, R.raw.a3, 1);
        sound_b = sP.load(this, R.raw.b3, 1);
        sound_c = sP.load(this, R.raw.c3, 1);
        sound_d = sP.load(this, R.raw.d3, 1);
        sound_e = sP.load(this, R.raw.e3, 1);
        sound_f = sP.load(this, R.raw.f3, 1);
        sound_g = sP.load(this, R.raw.g3, 1);
        sound_c2 = sP.load(this, R.raw.c4, 1);
